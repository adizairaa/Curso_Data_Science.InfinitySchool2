...
# Crie um programa em Python que cadastre alunos e suas notas em diferentes matérias. O programa deve: 1. Permitir cadastrar o nome de um aluno. 2. Associar um dicionário com matérias e notas desse aluno. 3. Exibir todos os alunos cadastrados com suas notas. 
