# Crie um programa que peça ao usuário um número inteiro e determine: Se o número é positivo, negativo ou zero.
#  Se o número é par ou ímpar (apenas se for diferente de zero). 
