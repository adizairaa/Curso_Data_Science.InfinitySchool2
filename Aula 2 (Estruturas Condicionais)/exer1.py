# Crie um programa em Python que: Peça ao usuário duas notas para dois alunos (total de 4 notas).
#  Calcule a média de cada aluno. 
# Exiba para cada aluno a mensagem correspondente: "Aprovado" se a média for maior ou igual a 7;
